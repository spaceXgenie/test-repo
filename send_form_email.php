...
if(isset($_POST['yourEmail'])) {
    ...
    $email_to = "brookhouseconstructions@gmail.com";
 
    $email_subject = "Thank you for contacting Brookhouse";
    ...
    function died($error) {
        ...
        echo " The details you submitted are . ";
  ...
  if(!preg_match($email_exp,$your_email)) {
    ...
    $error_message .= 'The Email Address you entered does not appear to be valid bitch.<br />';
